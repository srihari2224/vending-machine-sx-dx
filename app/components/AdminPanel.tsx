...
export default function AdminPanel({ kioskId, onExit }: { kioskId: string; onExit: () => void }) {
  ...
  useEffect(() => {
    fetch(`${KIOSK_BACKEND}/api/kiosk/${kioskId}`)
      .then((r) => r.json())
      .then((d) => {
        if (d.success) setKiosk(d.kiosk)
        else showMsg("Could not load kiosk data", true)
      })
  ...
  useEffect(() => {
    if (printers.length > 0 && levels.length === 0) {
      setLevels(printers.map((p) => p.current))
    }
  ...
  return (
    <div style={{
      ...
      {/* ── Vertical grid lines (brutalist motif) ── */}
      <div style={{ position: "fixed", top: 0, left: "16.6%", width: 1, height: "100%", background: c.gridLine, pointerEvents: "none", zIndex: 0 }} />
      <div style={{ position: "fixed", top: 0, left: "50%", width: 1, height: "100%", background: c.gridLine, pointerEvents: "none", zIndex: 0 }} />
      <div style={{ position: "fixed", top: 0, left: "83.3%", width: 1, height: "100%", background: c.gridLine, pointerEvents: "none", zIndex: 0 }} />

      {/* ── Header ── */}
      <div style={{
        height: 64, borderBottom: `1px solid ${c.border}`,
        display: "flex", alignItems: "center", justifyContent: "space-between",
        padding: "0 32px", background: c.bgPanel, position: "relative", zIndex: 10,
        flexShrink: 0,
      }}>
        {/* Left: brand + title */}
        <div>
          ...
          <div style={{
            ...
            letterSpacing: "-0.02em", lineHeight: 1, color: c.fg,
          }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <button
            ...
            style={{
              ...
              color: c.fgSub, padding: "7px 14px", cursor: "pointer",
          ...
          <button
            ...
            style={{
              ...
              color: c.fgSub, padding: "8px 20px", cursor: "pointer",
              fontFamily: '"Inter", sans-serif', fontSize: "0.6rem",
              fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.2em",
              transition: "all 0.2s",
            }}
      ...
      <div style={{
        ...
        {loading ? (
          <div style={{
            ...
            height: "100%", color: c.fgDim, fontSize: "0.75rem",
          ...
          <div style={{ display: "flex", gap: 0, height: "100%" }}>
            ...
            <div style={{
              ...
              background: c.bgPanel, padding: "48px 32px", flexShrink: 0,
            }}>
              <div style={{
                fontSize: "0.55rem", fontWeight: 700, letterSpacing: "0.28em",
              ...
              {infoRows.map(({ label, value }, i) => (
                <div key={label} style={{
                  ...
                  <span style={{
                    ...
                    textTransform: "uppercase", color: c.fgDim,
              ...
              {kiosk?.cpuUsername && kiosk?.ipAddress && (
                <div style={{
                  ...
                  background: c.sshBg, border: `1px solid ${c.border}`,
                }}>
                  <div style={{
                    fontSize: "0.45rem", fontWeight: 700, letterSpacing: "0.25em",
                    textTransform: "uppercase", color: c.fgDim,
                  ...
                  <code style={{
                    fontSize: "0.7rem", color: c.accent,
                    fontFamily: '"Space Mono", monospace',
                  }}>
            ...
            {/* ── Right column: Printer panels ── */}
            <div style={{ flex: 1, padding: "48px 40px", overflowY: "auto" }}>
              <div style={{
                fontSize: "0.55rem", fontWeight: 700, letterSpacing: "0.28em",
                textTransform: "uppercase", color: c.fgDim, marginBottom: 32,
                fontFamily: '"Space Mono", monospace',
              }}>
                Hardware Status
              </div>
                  ...
                  return (
                    <motion.div
                      ...
                      style={{
                        ...
                        background: c.bgCard, padding: "32px 36px",
                        marginBottom: 16,
                      }}
                    >
                      {/* Printer header */}
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 28 }}>
                        ...
                        <div style={{
                          ...
                          lineHeight: 1, color: levelColor(pct), fontVariantNumeric: "tabular-nums",
                        }}>
                          {pct}%
                        </div>
                      </div>

                      {/* Progress track — brutalist sharp */}
        ...
        {msg && (
          <motion.div
            ...
            style={{
              ...
              padding: "10px 24px",
              background: msg.isError ? "rgba(239,68,68,0.08)" : "rgba(34,197,94,0.08)",
              border: `1px solid ${msg.isError ? "rgba(239,68,68,0.4)" : "rgba(34,197,94,0.4)"}`,
